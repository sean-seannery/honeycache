...
public class HbaseEndpoint extends Endpoint{
	...
	public HbaseEndpoint(String newHost, int newPort, String newUser, String newPassword){
	...
	public void putCacheData(HCacheSQLQuery query, ResultSet res, String contentPolicy) throws SQLException {
		...
		if (contentPolicy.equals(CachePolicy.CACHE_QUERY_CONTENT)) {
			createAndInsertStatement = "CREATE EXTERNAL TABLE " + new_data_table_name 
					+ " STORED BY 'org.apache.hadoop.hive.hbase.HBaseStorageHandler' "
					+ "AS " + query.getQueryString();
		} else {
